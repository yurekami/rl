...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    pkg_path /tmp/tmpay61pxq8/model.pt2
    tensor(1)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [torch.onnx] Optimize the ONNX graph... ✅
    ONNX rollout took 622.8273 msec (total =  0.6228 sec since last reset).
    TorchRL version took 1867.3618 msec (total =  1.8674 sec since last reset).
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 23.028 seconds)
